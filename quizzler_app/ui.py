...
class QuizzlerInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.true_button = Button(image=self.true_img, highlightthickness=0, command=self.true_button_answer )
        self.true_button.grid(column=0, row=2, pady=50)

        self.false_img = PhotoImage(file="images/false.png")
        self.false_button = Button(image=self.false_img, highlightthickness=0, command=self.false_button_answer)
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.canvas.itemconfig(self.canvas_text, text="You have reached the END.")
